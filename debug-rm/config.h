...
/* Define this if you want to compile out the debug log messages. This will
   reduce the size of the binaries. */
/* #undef NTFS_DISABLE_DEBUG_LOGGING */
...
#define PACKAGE_STRING "ntfsprogs 1.13.1-WIP"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ntfsprogs"

/* Define to the version of this package. */
#define PACKAGE_VERSION "1.13.1-WIP"

/* Define to 1 if you have the ANSI C header files. */
#define STDC_HEADERS 1

/* Version number of package */
#define VERSION "1.13.1-WIP"
